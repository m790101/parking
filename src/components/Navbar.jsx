...
return (
    ...
    <ul className='nav-phone__panel d-flex align-items-center justify-content-evenly container'>
    ...
    <ul className='nav-desk__panel d-flex  flex-column align-items-center justify-content-evenly container'>
